...
import { ChevronDown, ChevronUp, Clock, MoreHorizontal, RefreshCcw, Search, Trash, TrashIcon, X } from 'lucide-react';
   ...
   data : deleted,
    ...
    const handleSort=(field)=> {
      setSortConfig(current => ({
            field,
            direction:
            current.field == field && current.direction  == "asc" ?"des" : "asc"
      }));
    };
